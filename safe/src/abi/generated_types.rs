...
unsafe extern "C" {
    ...
    pub fn SDL_SemWaitTimeout(sem: *mut SDL_sem, timeout: Uint32) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub const SDL_PixelFormatEnum_SDL_PIXELFORMAT_INDEX2LSB: SDL_PixelFormatEnum = 470811136;
pub const SDL_PixelFormatEnum_SDL_PIXELFORMAT_INDEX2MSB: SDL_PixelFormatEnum = 471859712;
...
pub const SDL_DisplayEventID_SDL_DISPLAYEVENT_MOVED: SDL_DisplayEventID = 4;
...
pub const SDL_GameControllerType_SDL_CONTROLLER_TYPE_MAX: SDL_GameControllerType = 14;
...
pub const SDL_EventType_SDL_CONTROLLERUPDATECOMPLETE_RESERVED_FOR_SDL3: SDL_EventType = 1626;
#[doc = "< Game controller Steam handle has changed"]
pub const SDL_EventType_SDL_CONTROLLERSTEAMHANDLEUPDATED: SDL_EventType = 1627;
